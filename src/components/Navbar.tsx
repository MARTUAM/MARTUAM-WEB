...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-6 py-0 flex justify-between items-center bg-martuam-navy/40 backdrop-blur-md border-b border-white/5 h-12 md:h-16">
